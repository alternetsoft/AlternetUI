...
set PublishManifest=%SCRIPT_HOME%\..\..\Integration\VisualStudio\Publish\extension.V2019.manifest.json
...
set PackagePath=%PublishRoot%\Alternet.UI.Integration.VisualStudio.VS2019-0.1.78-beta.vsix
