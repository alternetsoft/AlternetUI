...
ALTERNET_UI_API Int32Size_C GridBagSizer_CalcMin_(void* handle)
{
    return GridBagSizer::CalcMin(handle);
}

ALTERNET_UI_API void* GridBagSizer_FindItemAtPoint_(void* handle, Int32Point pt)
{
    return GridBagSizer::FindItemAtPoint(handle, pt);
}

ALTERNET_UI_API void* GridBagSizer_FindItemAtPosition_(void* handle, Int32Point pos)
{
...
ALTERNET_UI_API Int32Size_C GridBagSizer_GetCellSize_(void* handle, int row, int col)
{
    return GridBagSizer::GetCellSize(handle, row, col);
}

ALTERNET_UI_API Int32Size_C GridBagSizer_GetEmptyCellSize_(void* handle)
{
    return GridBagSizer::GetEmptyCellSize(handle);
}

ALTERNET_UI_API void GridBagSizer_RepositionChildren_(void* handle, Int32Size minSize)
{
    GridBagSizer::RepositionChildren(handle, minSize);
}

ALTERNET_UI_API void GridBagSizer_SetEmptyCellSize_(void* handle, Int32Size sz)
{
    GridBagSizer::SetEmptyCellSize(handle, sz);
}

ALTERNET_UI_API void* GridBagSizer_Add_(void* handle, void* window, Int32Point pos, Int32Size span, int flag, int border, void* userData)
{
    return GridBagSizer::Add(handle, window, pos, span, flag, border, userData);
}

ALTERNET_UI_API void* GridBagSizer_Add2_(void* handle, void* sizer, Int32Point pos, Int32Size span, int flag, int border, void* userData)
{
...
ALTERNET_UI_API void* GridBagSizer_Add4_(void* handle, int width, int height, Int32Point pos, Int32Size span, int flag, int border, void* userData)
{
...
ALTERNET_UI_API c_bool GridBagSizer_CheckForIntersection2_(void* handle, Int32Point pos, Int32Size span, void* excludeItem)
{
...
ALTERNET_UI_API Int32Point_C GridBagSizer_GetItemPosition_(void* handle, void* window)
{
    return GridBagSizer::GetItemPosition(handle, window);
}

ALTERNET_UI_API Int32Point_C GridBagSizer_GetItemPosition2_(void* handle, void* sizer)
{
    return GridBagSizer::GetItemPosition2(handle, sizer);
}

ALTERNET_UI_API Int32Point_C GridBagSizer_GetItemPosition3_(void* handle, int index)
{
    return GridBagSizer::GetItemPosition3(handle, index);
}

ALTERNET_UI_API Int32Point_C GridBagSizer_GetItemSpan_(void* handle, void* window)
{
    return GridBagSizer::GetItemSpan(handle, window);
}

ALTERNET_UI_API Int32Point_C GridBagSizer_GetItemSpan2_(void* handle, void* sizer)
{
    return GridBagSizer::GetItemSpan2(handle, sizer);
}

ALTERNET_UI_API Int32Point_C GridBagSizer_GetItemSpan3_(void* handle, int index)
{
    return GridBagSizer::GetItemSpan3(handle, index);
}

ALTERNET_UI_API c_bool GridBagSizer_SetItemPosition_(void* handle, void* window, Int32Point pos)
{
    return GridBagSizer::SetItemPosition(handle, window, pos);
}

ALTERNET_UI_API c_bool GridBagSizer_SetItemPosition2_(void* handle, void* sizer, Int32Point pos)
{
    return GridBagSizer::SetItemPosition2(handle, sizer, pos);
}

ALTERNET_UI_API c_bool GridBagSizer_SetItemPosition3_(void* handle, int index, Int32Point pos)
{
    return GridBagSizer::SetItemPosition3(handle, index, pos);
}

ALTERNET_UI_API c_bool GridBagSizer_SetItemSpan_(void* handle, void* window, Int32Size span)
{
    return GridBagSizer::SetItemSpan(handle, window, span);
}

ALTERNET_UI_API c_bool GridBagSizer_SetItemSpan2_(void* handle, void* sizer, Int32Size span)
{
    return GridBagSizer::SetItemSpan2(handle, sizer, span);
}

ALTERNET_UI_API c_bool GridBagSizer_SetItemSpan3_(void* handle, int index, Int32Size span)
{
