...
class wxAlternetTextSizerWrapper : public wxTextWrapper
{
public:
    wxAlternetTextSizerWrapper(wxWindow* win, const wxColour& fgColor)
    {
        m_win = win;
        m_hLine = 0;
        m_fgColor = fgColor;
...
protected:
    ...
    virtual wxWindow* OnCreateLine(const wxString& line)
    {
        ...
        if (m_fgColor.IsOk())
            control->SetForegroundColour(m_fgColor);
        return control;
    }
...
class wxAlternetRichToolTipPopup :
...
public:
    ...
    void SetTimeoutAndShow(unsigned timeout, unsigned delay)
    {
        ...
        Bind(wxEVT_TIMER, &wxAlternetRichToolTipPopup::OnTimer, this);
...
void
wxAlternetRichToolTipImpl::SetBackgroundColour(const wxColour& col,
...
void wxAlternetRichToolTipImpl::SetCustomIcon(const wxBitmapBundle& icon)
{
    m_icon = icon;
}

void wxAlternetRichToolTipImpl::SetStandardIcon(int icon)
{
...
void wxAlternetRichToolTipImpl::SetTimeout(unsigned millisecondsTimeout,
...
void wxAlternetRichToolTipImpl::SetTipKind(wxTipKind tipKind)
{
    m_tipKind = tipKind;
}

void wxAlternetRichToolTipImpl::SetForegroundColour(const wxColour& col)
{
    m_fgColor = col;
}

void wxAlternetRichToolTipImpl::SetTitleForegroundColour(const wxColour& col)
{
    m_titlefgColor = col;
}

void wxAlternetRichToolTipImpl::SetTitleFont(const wxFont& font)
{
    m_titleFont = font;
}

void wxAlternetRichToolTipImpl::ShowFor(wxWindow* win, const wxRect* rect)
{
    wxAlternetRichToolTipPopup* const popup = new wxAlternetRichToolTipPopup
    (
        win,
        m_title,
        m_message,
