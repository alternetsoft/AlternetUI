...
namespace Alternet.UI
{
    ...
    public static class BaseMemory
    {
        ...
        /// It must be previously allocated by <see cref="Alloc"/> and not yet freed with
        /// <see cref="FreeMem"/>,
        ...
        /// <returns>
        /// On success, returns a pointer to the beginning of newly allocated memory. To avoid
        /// a memory leak,
        /// the returned pointer must be deallocated with <see cref="FreeMem"/> or <see cref="Realloc"/>.
        /// The original pointer <paramref name="ptr"/> is invalidated and any access to it is
        /// undefined behavior
        /// (even if reallocation was in-place). On failure, returns a null pointer.
        /// The original pointer <paramref name="ptr"/>
        ...
        /// area pointed to by
        /// <paramref name="ptr"/>, if possible. The contents of the area remain unchanged up to
        /// the lesser
        /// of the new and old sizes. If the area is expanded, the contents of the new part of
        /// the array are undefined.
        /// Method 2. Allocating a new memory block of size <paramref name="newSize"/> bytes,
        ...
        /// </remarks>
        /// <remarks>
        /// If <paramref name="ptr"/> is a null pointer, the behavior is the same as calling
        /// <see cref="Alloc"/> with the
        /// <paramref name="newSize"/> parameter value.
        /// </remarks>
        /// <remarks>
        /// If <paramref name="newSize"/> is zero, the behavior is implementation defined:
        /// null pointer may be
        /// returned (in which case the old memory block may or may not be freed) or some
        /// non-null pointer may
        ...
        /// The behavior is undefined if the memory area referred to by <paramref name="ptr"/>
        /// has already been deallocated.
        /// The behavior is undefined if after <see cref="FreeMem"/> returns, an access is
        /// made through the pointer
        /// <paramref name="ptr"/> (unless another allocation function happened to result
        ...
        /// <paramref name="src"/> to the
        /// object pointed to by <paramref name="dest"/>. Both objects are reinterpreted
        /// as arrays of byte.
        /// </summary>
        ...
        /// <summary>
        /// Copies <paramref name="count"/> bytes from the object pointed to by
        /// <paramref name="src"/> to the object
        ...
        /// If either <paramref name="dest"/> or <paramref name="src"/> is an invalid
        ...
        /// If <paramref name="count"/> is greater
