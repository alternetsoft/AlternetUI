...
namespace Alternet.UI
{
    ...
    public enum Keys
    {
        ...
        /// <summary>The IME Hanguel mode key
        /// (maintained for compatibility; use <see langword="HangulMode" />).</summary>
        ...
        /// <summary>The IME accept key, replaces <see cref="Keys.IMEAceept" />.</summary>
        IMEAccept = 0x1E,

        /// <summary>The IME accept key. Obsolete, use <see cref="Keys.IMEAccept" /> instead.</summary>
        IMEAceept = IMEAccept,
        ...
        /// <summary>The OEM 1 key, same as code OemSemicolon.</summary>
        Oem1 = OemSemicolon,
        ...
        /// <summary>The OEM 2 key, same as code OemQuestion.</summary>
        Oem2 = OemQuestion,

        /// <summary>The OEM tilde key on a US standard keyboard (Windows 2000 or later).</summary>
        Oemtilde = 0xC0,

        /// <summary>The OEM 3 key, same as Oemtilde.</summary>
        Oem3 = Oemtilde,

        /// <summary>The OEM open bracket key on a US standard keyboard (Windows 2000 or later).</summary>
        OemOpenBrackets = 0xDB,

        /// <summary>The OEM 4 key, same as OemOpenBrackets.</summary>
        Oem4 = OemOpenBrackets,

        /// <summary>The OEM pipe key on a US standard keyboard (Windows 2000 or later).</summary>
        OemPipe = 0xDC,

        /// <summary>The OEM 5 key, same code as OemPipe.</summary>
        Oem5 = OemPipe,

        /// <summary>The OEM close bracket key on a US standard keyboard (Windows 2000 or later).</summary>
        OemCloseBrackets = 0xDD,

        /// <summary>The OEM 6 key, same code as OemCloseBrackets.</summary>
        Oem6 = OemCloseBrackets,

        /// <summary>The OEM singled/double quote key
        /// on a US standard keyboard (Windows 2000 or later).</summary>
        OemQuotes = 0xDE,

        /// <summary>The OEM 7 key, same code as OemQuotes.</summary>
        Oem7 = OemQuotes,

        /// <summary>The OEM 8 key.</summary>
        Oem8 = 0xDF,

        /// <summary>The OEM angle bracket or backslash key on the
        /// RT 102 key keyboard (Windows 2000 or later).</summary>
        OemBackslash = 0xE2,

        /// <summary>The OEM 102 key, same code as OemBackslash.</summary>
        Oem102 = OemBackslash,
        ...
        /// The Packet key value is the low word of a 32-bit virtual-key value
        /// used for non-keyboard input methods.</summary>
        Packet = 0xE7,
