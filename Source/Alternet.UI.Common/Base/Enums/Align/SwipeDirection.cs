...
namespace Alternet.UI
{
    ...
    {
        /// <summary>Indicates a presence of rightward swipe.</summary>
        Right = 1,

        /// <summary>Indicates a presence of leftward swipe.</summary>
        Left = 2,

        /// <summary>Indicates a presence of upward swipe.</summary>
        Up = 4,

        /// <summary>Indicates a presence of downward swipe.</summary>
        Down = 8
    }
