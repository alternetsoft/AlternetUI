...
{
    /// <summary>
    /// Represents the method that will handle the create property item event.
    /// </summary>
    ...
    /// <summary>
    /// Provides data for the create property item event.
    /// </summary>
    public class CreatePropertyEventArgs : HandledEventArgs
    {
        ...
        /// default value (null). In this case property item will not be added.
        /// </remarks>
