...
namespace Alternet.UI
{
    public partial class AbstractControl
    {
        ...
        /// <summary>
        /// Finds the first child control with the specified custom attribute name and value.
        /// </summary>
        /// <param name="attrName">The name of the custom attribute.</param>
        /// <param name="value">The value of the custom attribute.</param>
        /// <returns>The first child control with the specified custom attribute name and value,
        /// or null if not found.</returns>
        public virtual AbstractControl? FindChildWithAttr(string? attrName, object? value)
        {
            if (attrName is null || !HasChildren)
                return null;
            foreach (var item in Children)
            {
                var attrValue = item.CustomAttr[attrName];
