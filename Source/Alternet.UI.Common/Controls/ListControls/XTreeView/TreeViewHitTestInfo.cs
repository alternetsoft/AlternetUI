...
namespace Alternet.UI
{
    ...
    /// result for a <see cref="XTreeView"/> control.
    /// </summary>
    public class TreeViewHitTestInfo : BaseObject
    {
        ...
        /// <summary>
        /// Gets the location of a hit test on a <see cref="XTreeView"/> control,
        /// in relation to the <see cref="XTreeView"/> and the nodes it contains.
        /// </summary>
