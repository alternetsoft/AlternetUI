...
namespace Alternet.UI
{
    public partial class ComboBox
        : Control, IReadOnlyStrings, IListControl<object>
    {
        private StringSearch? search;
        private BaseCollection<object>? items;
        ...
        /// for display purposes or the real value.</param>
        public virtual string GetItemText(object? item, bool forDisplay)
        {
            if (item is null)
                return string.Empty;
            if (item is string s)
        ...
        /// </remarks>
        public virtual void SetCount(int newCount, Func<object> createItem)
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual BaseCollection<object> SafeItems()
        {
            if(items is null)
            {
                items = new NotNullCollection<object>();
                AttachItems(items);
            }
