...
namespace Alternet.UI
{
    ...
    /// result for a <see cref="StdTreeView"/> control.
    /// </summary>
    public class TreeViewHitTestInfo : BaseObject
    {
        ...
        /// <summary>
        /// Gets the location of a hit test on a <see cref="StdTreeView"/> control,
        /// in relation to the <see cref="StdTreeView"/> and the nodes it contains.
        /// </summary>
