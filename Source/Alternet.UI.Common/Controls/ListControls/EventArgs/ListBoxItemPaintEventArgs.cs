...
namespace Alternet.UI
{
    ...
    public class ListBoxItemPaintEventArgs : PaintEventArgs
    {
        ...
        /// <summary>
        /// Gets or sets a rectangle that overrides the default selection rectangle for the item being painted.
        /// </summary>
        public RectD? SelectionRectOverride { get; set; }
        ...
        /// <summary>
        /// Gets text color for the specified item and selection state.
        /// </summary>
