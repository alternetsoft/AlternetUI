...
namespace Alternet.UI
{
    ...
    public partial class SpeedButton : GenericControl, ICommandSource
    {
        ...
        public SpeedButton(AbstractControl parent)
            : this()
        {
            Parent = parent;
        }
        ...
        /// <param name="sizeFallbackOptions">The options to use
        /// when the specified icon size is not available.</param>
            ...
            ImageSizeFallbackOptions? sizeFallbackOptions = null)
        {
            ...
            {
                drawable.Icon = icon;
                drawable.SizeFallbackOptions = sizeFallbackOptions;
                PictureSizeChanged();
            });
        }
        ...
        /// <summary>
        /// Retrieves the background color based on the specified visual state.
        /// </summary>
        ...
        public virtual Color? GetBackColor(VisualControlState state)
        {
            ...
            {
                var theme = GetDefaultTheme()?.DarkOrLight(IsDarkBackground);
                backColor ??= theme?.Colors?.GetObjectOrNull(state)?.BackgroundColor;
            }
