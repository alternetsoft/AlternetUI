...
namespace Alternet.UI
{
    ...
    public abstract partial class GenericControlAndButton : GenericControlAndPicture, INotifyDataErrorInfo
    {
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// This property affects all <see cref="GenericControlAndButton"/> descendants created after
        /// it was changed.
        /// </remarks>
        public static bool IsMinusButtonFirst = true;

        private readonly ToolBar buttons;
        private readonly GenericControl mainControl;
        ...
        private GenericControl? substituteControl;

        /// <summary>
        /// Initializes a new instance of the <see cref="GenericControlAndButton"/> class
        /// with the specified parent control.
        /// </summary>
        /// <param name="parent">Parent of the control.</param>
        public GenericControlAndButton(AbstractControl parent)
            : this()
        {
            Parent = parent;
        }
        ...
        /// </summary>
        [Browsable(false)]
        public virtual GenericControl SubstituteControl
        {
            get
            {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual GenericControl CreateSubstituteControl()
        {
            return new Label();
        }
