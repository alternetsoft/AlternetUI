...
namespace Alternet.UI
{
    ...
    public partial class TabControl : HiddenBorder
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            TabControlDrawInterior.Default.DrawTabControlInterior(ref prm);
        }
        ...
        protected virtual void OnHeaderPaint(object? sender, PaintEventArgs e)
        {
            ...
            var prm = GetTabHeaderInteriorDrawParams(e);
            TabControlDrawInterior.Default.DrawTabHeaderInterior(ref prm);
        }

        /// <summary>
        /// Creates parameters for drawing the interior of the tab header.
        /// </summary>
        /// <param name="e">The event arguments containing information about the paint event.</param>
        /// <returns>The parameters for drawing the interior of the tab header.</returns>
        protected virtual TabControlDrawInterior.TabHeaderInteriorDrawParams GetTabHeaderInteriorDrawParams(PaintEventArgs e)
        {
