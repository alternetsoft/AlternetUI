...
#pragma warning restore
        ...
        internal static void TestNewPainting(TabControl tc, PaintEventArgs e)
        {
            ...
            if (tabCount > 0)
            {
                ...
                e.Graphics.FillRectangle(ThemedColors.Green.GetColor(tc).WithAlpha(50).AsBrush, r1);
                e.Graphics.FillRectangle(ThemedColors.Red.GetColor(tc).WithAlpha(50).AsBrush, r2);
                ...
                canvas.Canvas.DrawPath(path, ThemedColors.Red.GetColor(tc).AsPen);
