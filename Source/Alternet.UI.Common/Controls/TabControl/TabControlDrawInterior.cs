...
#pragma warning restore
        ...
        internal static void TestNewPainting(TabControl tc, PaintEventArgs e)
        {
            ...
            if (tabCount > 0)
            {
                ...
                e.Graphics.FillRectangle(LightDarkColors.Green.GetColor(tc).WithAlpha(50).AsBrush, r1);
                e.Graphics.FillRectangle(LightDarkColors.Red.GetColor(tc).WithAlpha(50).AsBrush, r2);
                ...
                canvas.Canvas.DrawPath(path, LightDarkColors.Red.GetColor(tc).AsPen);
