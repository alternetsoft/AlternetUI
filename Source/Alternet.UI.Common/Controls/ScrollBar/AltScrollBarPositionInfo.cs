...
namespace Alternet.UI
{
    ...
    /// </summary>
    public class AltScrollBarPositionInfo : ImmutableObject
    {
        private static AltScrollBarPositionInfo? def;

        private Record record = new();

        /// <summary>
        /// Initializes a new instance of the <see cref="AltScrollBarPositionInfo"/> struct.
        /// </summary>
        public AltScrollBarPositionInfo()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="AltScrollBarPositionInfo"/> class.
        /// </summary>
        /// <param name="immutable">Whether this object is immutable.</param>
        public AltScrollBarPositionInfo(bool immutable)
        {
            SetImmutable(immutable);
        }

        /// <summary>
        /// Gets default <see cref="AltScrollBarPositionInfo"/> object.
        /// Returned value is immutable and its properties are read only.
        /// </summary>
        public static AltScrollBarPositionInfo Default
        {
            get
            {
                return def ??= new(true);
        ...
        {
            /// <inheritdoc cref="AltScrollBarPositionInfo.Minimum"/>
            public int Minimum;

            /// <inheritdoc cref="AltScrollBarPositionInfo.Maximum"/>
            public int Maximum = 100;

            /// <inheritdoc cref="AltScrollBarPositionInfo.SmallChange"/>
            public int SmallChange = 1;

            /// <inheritdoc cref="AltScrollBarPositionInfo.LargeChange"/>
            public int LargeChange = 10;

            /// <inheritdoc cref="AltScrollBarPositionInfo.Value"/>
            public int Value;
