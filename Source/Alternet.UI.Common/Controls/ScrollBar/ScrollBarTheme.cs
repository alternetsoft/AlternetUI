...
namespace Alternet.UI
{
    ...
    /// </summary>
    public class ScrollBarThemeInitializeArgs : BaseEventArgs
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollBarThemeInitializeArgs"/> class.
        /// </summary>
        /// <param name="metrics">Scrollbar theme settings.</param>
        public ScrollBarThemeInitializeArgs(ScrollBarTheme metrics)
        {
            Metrics = metrics;
        }
        ...
        /// </summary>
        public ScrollBarTheme Metrics { get; set; }
    }
    ...
    /// </summary>
    public class ScrollBarTheme : CustomScrollBarTheme
    {
        private static KnownScrollBarTheme systemTheme = KnownScrollBarTheme.WindowsAuto;

        /// <summary>
        /// Gets or sets which theme to use when <see cref="KnownScrollBarTheme.System"/> is used.
        /// </summary>
        public static KnownScrollBarTheme SystemTheme
        {
            get
            {
                return systemTheme;
            ...
            set
            {
                if (value == KnownScrollBarTheme.System)
                    return;
                systemTheme = value;
            }
        }
        ...
        private static ScrollBarTheme? visualStudioLight;
        private static ScrollBarTheme? visualStudioDark;
        private static ScrollBarTheme? windowsLight;
        ...
        /// </summary>
        public event EventHandler<ScrollBarThemeInitializeArgs>? ThemeInitialize;
        ...
        /// <summary>
        /// Gets or sets 'Maui Dark' theme colors as <see cref="ScrollBarTheme"/>.
        /// </summary>
        public static ScrollBarTheme MauiDarkTheme
        {
            get
            {
                if (mauiDark is null)
        ...
        /// <summary>
        /// Gets or sets 'Maui Light' theme colors as <see cref="ScrollBarTheme"/>.
        /// </summary>
        public static ScrollBarTheme MauiLightTheme
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets 'Windows Dark' theme colors as <see cref="ScrollBarTheme"/>.
        /// </summary>
        public static ScrollBarTheme WindowsDarkTheme
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets 'Windows Light' theme colors as <see cref="ScrollBarTheme"/>.
        /// </summary>
        public static ScrollBarTheme WindowsLightTheme
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets 'Visual Studio Dark' theme colors as <see cref="ScrollBarTheme"/>.
        /// </summary>
        public static ScrollBarTheme VisualStudioDarkTheme
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets 'Visual Studio Light' theme colors as <see cref="ScrollBarTheme"/>.
        /// </summary>
        public static ScrollBarTheme VisualStudioLightTheme
        {
            get
            {
        ...
        /// </summary>
        /// <returns>A <see cref="ScrollBarTheme"/> object representing
        /// the 'Windows Dark' theme.</returns>
        public static ScrollBarTheme CreateWindowsDarkTheme()
        {
            ScrollBarTheme windowsDark = new();
        ...
        public static ScrollBarTheme CreateWindowsLightTheme()
        {
            ScrollBarTheme windowsLight = new();
        ...
        /// <param name="theme"><see cref="KnownScrollBarTheme"/> value.</param>
        /// <returns></returns>
        public static ScrollBarTheme GetTheme(KnownScrollBarTheme theme, bool isDark = false)
        {
            switch (theme)
            {
                default:
                case KnownScrollBarTheme.System:
                    theme = SystemTheme;
                    if (theme == KnownScrollBarTheme.System)
                        theme = KnownScrollBarTheme.WindowsAuto;
                    return GetTheme(theme, isDark);
                case KnownScrollBarTheme.VisualStudioAuto:
                    if (isDark)
                        return VisualStudioDarkTheme;
                    return VisualStudioLightTheme;
                case KnownScrollBarTheme.VisualStudioLight:
                    return VisualStudioLightTheme;
                case KnownScrollBarTheme.VisualStudioDark:
                    return VisualStudioDarkTheme;
                case KnownScrollBarTheme.WindowsAuto:
                    if (isDark)
                        return WindowsDarkTheme;
                    return WindowsLightTheme;
                case KnownScrollBarTheme.WindowsDark:
                    return WindowsDarkTheme;
                case KnownScrollBarTheme.WindowsLight:
                    return WindowsLightTheme;
                case KnownScrollBarTheme.MauiDark:
                    return MauiDarkTheme;
                case KnownScrollBarTheme.MauiLight:
                    return MauiLightTheme;
                case KnownScrollBarTheme.MauiAuto:
                    if (isDark)
                        return MauiDarkTheme;
                    return MauiLightTheme;
            }
        ...
        public virtual void Assign(ScrollBarTheme assignFrom)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual ScrollBarTheme Clone()
        {
            ScrollBarTheme result = new();
            result.Assign(this);
            return result;
        }
        ...
        public override void AssignTo(InteriorDrawable interior)
        {
            ...
            {
                ScrollBarThemeInitializeArgs e = new(this);
                e.Interior = interior;
