...
namespace Alternet.UI
{
    ...
    public class ScrollBarMetricsInfo<T>
        where T : struct
    {
        /// <summary>
    ...
    /// Contains properties which specify different scrollbar metrics.
    /// </summary>
    public class ScrollBarMetricsInfo : ScrollBarMetricsInfo<int>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollBarMetricsInfo"/> class.
        /// </summary>
        public ScrollBarMetricsInfo(AbstractControl control)
        {
            Reset(control);
        }
