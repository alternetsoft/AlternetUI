...
{
    /// <summary>
    /// Implements <see cref="ushort"/> editor with validation.
    /// </summary>
    ...
    public partial class ValueEditorUInt16 : TextBoxAndLabel
    {
                   ...
                   : base(title)
        {
            if (value is not null)
                TextBox.ValueHelper.SetTextAsUInt16(value.Value);
        }
        ...
        {
            base.Init();
            TextBox.ValueHelper.InitAsUnsignedInt16(UseCharValidator);
        }
    }
}
