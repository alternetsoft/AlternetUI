...
namespace Alternet.UI
{
        ...
        ICollection<ColumnDefinition>, IEnumerable<ColumnDefinition>, IEnumerable, IList, ICollection
    {
        ...
        /// <param name="array">A zero-based <see cref="T:System.Array" /> that receives the copied items from the <see cref="GridColumnCollection" />.</param>
        ...
        /// <summary>Copies an array of <see cref="ColumnDefinition" /> objects to a given index position within a <see cref="GridColumnCollection" />.</summary>
        ...
        /// <param name="value">The <see cref="T:System.Object" /> to add to the <see cref="GridColumnCollection" />.</param>
        ...
        /// <summary>Adds a <see cref="ColumnDefinition" /> element to a <see cref="GridColumnCollection" />.</summary>
        ...
        /// <summary>Clears the content of the <see cref="GridColumnCollection" />.</summary>
        public void Clear()
        {
            this.PrivateVerifyWriteAccess();
            this.PrivateOnModified();
        ...
        /// <param name="value">The <see cref="T:System.Object" /> to locate in the <see cref="GridColumnCollection" />.</param>
        /// <returns>
        ///     <see langword="true" /> if the <see cref="T:System.Object" /> is found in the <see cref="GridColumnCollection" />; otherwise, <see langword="false" />.</returns>
        ...
        /// <summary>Determines whether a given <see cref="ColumnDefinition" /> exists within a <see cref="GridColumnCollection" />.</summary>
        ...
        /// <summary>Returns the index position of a given <see cref="ColumnDefinition" /> within a <see cref="GridColumnCollection" />.</summary>
        ...
        /// <param name="value">The <see cref="T:System.Object" /> to insert into the <see cref="GridColumnCollection" />.</param>
        ...
        /// <summary>Inserts a <see cref="ColumnDefinition" /> at the specified index position within a <see cref="GridColumnCollection" />.</summary>
        ...
        /// <param name="value">The <see cref="T:System.Object" /> to remove from the <see cref="GridColumnCollection" />.</param>
        ...
        /// <summary>Removes a <see cref="ColumnDefinition" /> from a <see cref="GridColumnCollection" />.</summary>
        ...
        /// <summary>Removes a <see cref="ColumnDefinition" /> from a <see cref="GridColumnCollection" /> at the specified index position.</summary>
        ...
        /// <summary>Removes a range of <see cref="ColumnDefinition" /> objects from a <see cref="GridColumnCollection" />.</summary>
        ...
        {
            return new GridColumnCollection.Enumerator(this);
        }
        ...
        /// <summary>Gets the total number of items within this instance of <see cref="GridColumnCollection" />.</summary>
        ...
        /// <returns>
        ///     <see langword="true" /> if the the <see cref="GridColumnCollection" /> has a fixed size; otherwise, <see langword="false" />.</returns>
        ...
        /// <summary>Gets a value that indicates whether a <see cref="GridColumnCollection" /> is read-only.</summary>
        /// <returns>
        ...
        /// <summary>Gets a value that indicates whether access to this <see cref="GridColumnCollection" /> is synchronized (thread safe).</summary>
        /// <returns>
        ...
        /// <summary>Gets an object that can be used to synchronize access to the <see cref="GridColumnCollection" />.</summary>
        /// <returns>An object that can be used to synchronize access to the <see cref="GridColumnCollection" />.</returns>
        ...
        /// <summary>Gets a value that indicates the current item within a <see cref="GridColumnCollection" />.</summary>
        ...
        {
            internal Enumerator(GridColumnCollection collection)
            {
            ...
            private GridColumnCollection _collection;
