...
namespace Alternet.UI
{
    ...
    public partial class SplittedTreeAndCards : LayoutPanel
    {
        ...
        {
            DebugBackgroundColor(ThemedColors.Green, nameof(SplittedTreeAndCards));
            Cards.DebugBackgroundColor(ThemedColors.Yellow, "SplittedTreeAndCards.Cards");
            ...
            static void CardPropertyChanged(object? sender, ObjectPropertyChangedEventArgs e)
            {
                ...
                if (card.ControlCreated)
                    card.Control.DebugBackgroundColor(ThemedColors.Blue, "SplittedTreeAndCards.Cards.card");
            }
        }
