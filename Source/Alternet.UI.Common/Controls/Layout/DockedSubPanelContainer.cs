...
namespace Alternet.UI
{
    ...
    public partial class DockedSubPanelContainer : LayoutPanel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DockedSubPanelContainer"/> class.
        /// </summary>
        /// <param name="parent">Parent of the control.</param>
        public DockedSubPanelContainer(AbstractControl parent)
            : this()
        {
            Parent = parent;
        }
        ...
        /// Initializes a new instance of the <see cref="DockedSubPanelContainer"/> class.
        /// </summary>
        public DockedSubPanelContainer()
        {
            CanSelect = false;
            TabStop = false;
