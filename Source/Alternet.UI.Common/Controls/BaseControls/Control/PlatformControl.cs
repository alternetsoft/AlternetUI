...
namespace Alternet.UI
{
    ...
    /// </summary>
    public class PlatformControl : Control
    {
        ...
        public PlatformControl(PlatformControl parent)
            : this()
        {
            Parent = parent;
        }
        ...
        /// <summary>
        /// Gets or sets whether <see cref="Control.Idle"/> event is fired.
        /// </summary>
        [Browsable(false)]
        ...
        /// <returns></returns>
        public static IControlHandler? RequireHandler(Control? control)
        {
            return (control as PlatformControl)?.Handler;
        }
        ...
        /// <inheritdoc/>
        public override void RaiseChildInserted(int index, Control childControl)
        {
        ...
        /// <inheritdoc/>
        public override void RaiseChildRemoved(Control childControl)
        {
