...
namespace Alternet.UI
{
    ...
    /// </summary>
    /// <remarks>This window provides an appropriate control for displaying multi-line message
    ...
    public partial class WindowWithMessageAndButton : DialogWindow
    {
        private readonly XTreeView detailsView = new()
        {
            SelectionMode = TreeViewSelectionMode.None,
            HasBorder = false,
        };

        private readonly XButton copyButton = new()
        {
        ...
        private readonly XButton closeButton = new()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WindowWithMessageAndButton"/> class.
        /// </summary>
        public WindowWithMessageAndButton(string title, string details)
        {
            InitializeControls(title, details);
        }

        /// <summary>
        /// Gets the control that displays the message.
        /// </summary>
        public XTreeView MessageView => detailsView;
        ...
        /// </summary>
        public XButton CloseButton => closeButton;
        ...
        {
            var window = new WindowWithMessageAndButton(title, details);
        ...
        protected virtual void InitializeControls(string title, string details)
        {
            ...
            var strings = StringUtils.Split(details);
            var root = new TreeViewRootItem();
            root.AddStrings(strings);

            detailsView.RootItem = root;
            detailsView.Parent = border;
            ...
            copyButton.Click += (o, e) => Clipboard.SetText(details);
