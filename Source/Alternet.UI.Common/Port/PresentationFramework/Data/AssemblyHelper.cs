...
/*
        ...
        internal static SystemXmlExtensionMethods ExtensionsForSystemXml(bool force=false)
        {
            ...
            {
                _systemXmlExtensionMethods = new SystemXmlExtension();// (SystemXmlExtensionMethods)LoadExtensionFor("SystemXml");
            }
        ...
        internal static SystemXmlLinqExtensionMethods ExtensionsForSystemXmlLinq(bool force=false)
        {
            ...
            {
                _systemXmlLinqExtensionMethods = new SystemXmlLinqExtension();// (SystemXmlLinqExtensionMethods)LoadExtensionFor("SystemXmlLinq");
            }
        ...
        internal static SystemDataExtensionMethods ExtensionsForSystemData(bool force=false)
        {
            ...
            {
                _systemDataExtensionMethods = new SystemDataExtension();// (SystemDataExtensionMethods)LoadExtensionFor("SystemData");
            }
        ...
        internal static SystemCoreExtensionMethods ExtensionsForSystemCore(bool force=false)
        {
            ...
            {
                _systemCoreExtensionMethods = new SystemCoreExtension();// (SystemCoreExtensionMethods)LoadExtensionFor("SystemCore");
            }
