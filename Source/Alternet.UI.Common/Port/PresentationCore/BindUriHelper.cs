...
namespace Alternet.UI.Port
{
   ...
   internal static  partial class BindUriHelper
   {
        ...
        internal static string GetReferer(Uri destinationUri)
        {
            ...
            Uri sourceUri = SiteOfOriginContainer.BrowserSource;
            if (sourceUri != null)
            {
                int sourceZone = CustomCredentialPolicy.MapUrlToZone(sourceUri);
                int targetZone = CustomCredentialPolicy.MapUrlToZone(destinationUri);
