namespace Alternet.Drawing
{
    ...
    public static class SystemColors
    {
        ...
        public static Color ActiveBorder = new(KnownSystemColor.ActiveBorder);

        /// <summary>Gets a <see cref="Color" /> structure that is the color
        /// of the background of the active window's title bar.</summary>
        /// <returns>A <see cref="Color" /> that is the color of the
        /// active window's title bar.</returns>
        public static Color ActiveCaption = new(KnownSystemColor.ActiveCaption);
        ...
        public static Color ActiveCaptionText = new(KnownSystemColor.ActiveCaptionText);

        /// <summary>Gets a <see cref="Color" /> structure that is the color
        /// of the application workspace. </summary>
        /// <returns>A <see cref="Color" /> that is the color of the
        /// application workspace.</returns>
        public static Color AppWorkspace = new(KnownSystemColor.AppWorkspace);
        ...
        public static Color ButtonFace = new(KnownSystemColor.ButtonFace);
        ...
        public static Color ButtonHighlight = new(KnownSystemColor.ButtonHighlight);

        /// <summary>Gets a <see cref="Color" /> structure that is the shadow
        /// color of a 3-D element. </summary>
        /// <returns>A <see cref="Color" /> that is the shadow color of
        /// a 3-D element.</returns>
        public static Color ButtonShadow = new(KnownSystemColor.ButtonShadow);

        /// <summary>Gets a <see cref="Color" /> structure that is the
        /// face color of a 3-D element.</summary>
        /// <returns>A <see cref="Color" /> that is the face color of
        /// a 3-D element.</returns>
        public static Color Control = new(KnownSystemColor.Control);
        ...
        public static Color ControlDark = new(KnownSystemColor.ControlDark);
        ...
        public static Color ControlLight = new(KnownSystemColor.ControlLight);
        ...
        public static Color GradientActiveCaption = new(KnownSystemColor.GradientActiveCaption);
        ...
        public static Color GrayText = new(KnownSystemColor.GrayText);
        ...
        /// items.</returns>
        public static Color Highlight = new(KnownSystemColor.Highlight);
        ...
        /// items.</returns>
        public static Color HighlightText = new(KnownSystemColor.HighlightText);
        ...
        /// item.</returns>
        public static Color HotTrack = new(KnownSystemColor.HotTrack);
        ...
        /// border.</returns>
        public static Color InactiveBorder = new(KnownSystemColor.InactiveBorder);
        ...
        public static Color InactiveCaption = new(KnownSystemColor.InactiveCaption);
        ...
        public static Color InactiveCaptionText = new(KnownSystemColor.InactiveCaptionText);
        ...
        public static Color Menu = new(KnownSystemColor.Menu);
        ...
        /// bar.</returns>
        public static Color MenuBar = new(KnownSystemColor.MenuBar);
        ...
        public static Color MenuHighlight = new(KnownSystemColor.MenuHighlight);

        /// <summary>Gets a <see cref="Color" /> structure that is the color of a menu's
        /// text.</summary>
        /// <returns>A <see cref="Color" /> that is the color of a menu's text.</returns>
        public static Color MenuText = new(KnownSystemColor.MenuText);

        /// <summary>Gets a <see cref="Color" /> structure that is the color of the background
        /// of a scroll bar.</summary>
        /// <returns>A <see cref="Color" /> that is the color of the background of a scroll
        /// bar.</returns>
        public static Color ScrollBar = new(KnownSystemColor.ScrollBar);
        ...
        public static Color WindowFrame = new(KnownSystemColor.WindowFrame);
        ...
        public static Color Window = new(KnownSystemColor.Window);
        ...
        /// of a window.</returns>
        public static Color WindowText = new(KnownSystemColor.WindowText);
