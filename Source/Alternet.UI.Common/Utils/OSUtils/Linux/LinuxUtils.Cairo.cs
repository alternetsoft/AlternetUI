...
namespace Alternet.UI
{
    public static partial class LinuxUtils
    {
        ...
        /// </summary>
        /// <param name="cr">
        /// A pointer to the native Cairo context (cairo_t*) provided by the GTK3 paint event.
        /// This parameter represents the drawing context for the target GTK3 surface.
        /// </param>
...
#pragma warning restore
            ...
            IntPtr caSurface = CairoNative.cairo_image_surface_create_for_data(
                pixels, CairoNative.CAIROFORMATARGB32, width, height, stride);
        ...
        public static class CairoNative
        {
            ...
            /// <param name="format">Cairo pixel format (e.g., <see cref="CAIROFORMATARGB32"/>).</param>
