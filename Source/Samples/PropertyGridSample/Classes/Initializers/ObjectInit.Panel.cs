...
namespace PropertyGridSample
{
    public partial class ObjectInit
    {
        ...
        public static void InitGenericTabControl(TabControl tabControl, bool withButtons = true)
        {
            ...
            tabControl.SetTabSvg(0, KnownSvgImages.ImgGear, null, LightDarkColors.Blue.LightOrDark(tabControl));
        ...
        {
            public Color SampleColor { get; set; } = LightDarkColors.Red.LightOrDark();
