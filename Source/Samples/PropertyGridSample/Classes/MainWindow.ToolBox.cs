    ...
    public partial class MainControl
    {
        ...
        private void InitToolBox()
        {
            ...
            void Fn()
            {
                ...
                ToolBoxAdd<Alternet.UI.ValueEditorDouble>(ObjectInit.InitValueEditorDouble);
                ToolBoxAdd<Alternet.UI.ValueEditorSingle>(ObjectInit.InitValueEditorSingle);
                ToolBoxAdd<Alternet.UI.ValueEditorUDouble>(ObjectInit.InitValueEditorUDouble);
                ToolBoxAdd<Alternet.UI.ValueEditorUSingle>(ObjectInit.InitValueEditorUSingle);
                ToolBoxAdd<Alternet.UI.ValueEditorInt16>(ObjectInit.InitValueEditorInt16);
                ToolBoxAdd<Alternet.UI.ValueEditorInt32>(ObjectInit.InitValueEditorInt32);
                ToolBoxAdd<Alternet.UI.ValueEditorInt64>(ObjectInit.InitValueEditorInt64);
                ToolBoxAdd<Alternet.UI.ValueEditorSByte>(ObjectInit.InitValueEditorSByte);
                ToolBoxAdd<Alternet.UI.ValueEditorEMail>(ObjectInit.InitValueEditorEMail);
                ToolBoxAdd<Alternet.UI.ValueEditorString>(ObjectInit.InitValueEditorString);
                ToolBoxAdd<Alternet.UI.ValueEditorUrl>(ObjectInit.InitValueEditorUrl);
                ToolBoxAdd<Alternet.UI.ValueEditorByte>(ObjectInit.InitValueEditorByte);
                ToolBoxAdd<Alternet.UI.ValueEditorUInt16>(ObjectInit.InitValueEditorUInt16);
                ToolBoxAdd<Alternet.UI.ValueEditorUInt32>(ObjectInit.InitValueEditorUInt32);
                ToolBoxAdd<Alternet.UI.ValueEditorUInt64>(ObjectInit.InitValueEditorUInt64);
                ToolBoxAdd<Alternet.UI.ColorPickerAndButton>();
                ToolBoxAdd<Alternet.UI.ComboBoxAndButton>();
                ToolBoxAdd<Alternet.UI.EnumPickerAndButton>(ObjectInit.InitEnumPickerAndButton);
                ToolBoxAdd<Alternet.UI.SpeedEnumButton>(ObjectInit.InitSpeedEnumButton);
