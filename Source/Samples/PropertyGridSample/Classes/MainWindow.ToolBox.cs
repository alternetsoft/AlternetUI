    ...
    public partial class MainControl
    {
        ...
        private void InitToolBox()
        {
            ...
            void Fn()
            {
                ...
                ToolBoxAdd<ColorPickerAndButton>();
                ToolBoxAdd<ComboBoxAndButton>();
                ToolBoxAdd<ComboBoxAndLabel>();
                ...
                ToolBoxAdd<EnumPickerAndButton>(ObjectInit.InitEnumPickerAndButton);
                ...
                ToolBoxAdd<SpeedButtonWithListPopup>();
                ToolBoxAdd<SpeedColorButton>(ObjectInit.InitSpeedColorButton);
                ToolBoxAdd<SpeedDateButton>();
                ToolBoxAdd<SpeedEnumButton>(ObjectInit.InitSpeedEnumButton);
                ...
                ToolBoxAdd<ValueEditorInt16>(ObjectInit.InitValueEditorInt16);
                ToolBoxAdd<ValueEditorInt32>(ObjectInit.InitValueEditorInt32);
                ToolBoxAdd<ValueEditorInt64>(ObjectInit.InitValueEditorInt64);
                ToolBoxAdd<ValueEditorSByte>(ObjectInit.InitValueEditorSByte);
                ToolBoxAdd<ValueEditorSingle>(ObjectInit.InitValueEditorSingle);
                ToolBoxAdd<ValueEditorString>(ObjectInit.InitValueEditorString);
                ToolBoxAdd<ValueEditorUDouble>(ObjectInit.InitValueEditorUDouble);
                ToolBoxAdd<ValueEditorUInt16>(ObjectInit.InitValueEditorUInt16);
                ToolBoxAdd<ValueEditorUInt32>(ObjectInit.InitValueEditorUInt32);
                ToolBoxAdd<ValueEditorUInt64>(ObjectInit.InitValueEditorUInt64);
                ToolBoxAdd<ValueEditorUrl>(ObjectInit.InitValueEditorUrl);
                ToolBoxAdd<ValueEditorUSingle>(ObjectInit.InitValueEditorUSingle);
                ToolBoxAdd<VerticalStackPanel>(ObjectInit.InitStackPanel);
                ToolBoxAdd<VirtualListBox>(DemoUtils.InitVirtualListBox);
