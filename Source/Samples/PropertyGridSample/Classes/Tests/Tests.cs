...
namespace PropertyGridSample
{
    public partial class MainControl
    {
        ...
        internal void InitTestsSpeedButton()
        {
            ...
            AddControlAction<SpeedButton>("Setup as CheckBox with border", (c) =>
            {
                c.Sticky = true;
        ...
        internal void InitTestsListBox()
        {
        ...
        internal void TestMemoFindReplace(bool replace)
        {
