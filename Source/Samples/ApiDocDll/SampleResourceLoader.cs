...
namespace ApiDoc
{
    internal static class SampleResourceLoader
    {
        ...
        private static ImageLists LoadImageListsCore()
        {
            ...
            var assembly = typeof(SampleResourceLoader).Assembly;
            var allResourceNames = assembly.GetManifestResourceNames();
            var allImageResourceNames = allResourceNames.Where(x => x.StartsWith("ApiDocDll.Resources.ImageListIcons."));
