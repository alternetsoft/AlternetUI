...
using Alternet.UI;                        // BaseCompatibilityPreferences
    ...
    public sealed class DispatcherSynchronizationContext : SynchronizationContext
    {
        ...
        public override int Wait(IntPtr[] waitHandles, bool waitAll, int millisecondsTimeout)
        {
            if(_dispatcher._disableProcessingCount > 0)
            {
                ...
                // yezo return MS.Win32.UnsafeNativeMethods.WaitForMultipleObjectsEx(waitHandles.Length, waitHandles, waitAll, millisecondsTimeout, false);
