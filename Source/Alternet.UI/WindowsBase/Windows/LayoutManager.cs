...
namespace Alternet.UI
{
    ...
    internal sealed class ContextLayoutManager : DispatcherObject
    {
        ...
        private void markTreeDirty(UIElement e)
        {
            ...
            while (true)
            {
                var p = e.GetUIParentNo3DTraversal() as UIElement;
                if (p == null) break;
                e = p;
            }
        ...
        private void markTreeDirtyHelper(UIElement v)
        {
        ...
        internal void UpdateLayout()
        {
            ...
            //MS.Internal.Text.TextInterface.Font.ResetFontFaceCache(); // yezo
            ...
            internal void Add(UIElement e)
            {
                ...
                else
                {
                    ...
                    while (e != null)
                    {
                        ...
                        if (p != null && p.Visible) //not yet a root or a collapsed node
                        {
                            Remove(e);
                        }
