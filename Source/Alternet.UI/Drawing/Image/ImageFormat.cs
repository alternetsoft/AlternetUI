...
namespace Alternet.Drawing
{
    ...
    public sealed class ImageFormat
    {
        ...
        /// <see cref="ImageFormat" /> class by using
        /// the specified <see cref="Guid" /> structure.</summary>
        /// <param name="guid">The <see cref="Guid" /> structure that
        ...
        /// <returns>An <see cref="ImageFormat" />
        ...
        /// <returns>An <see cref="ImageFormat" /> object
        ...
        /// this <see cref="ImageFormat" /> object.</summary>
        /// <returns>A <see cref="Guid" /> structure that represents this
        /// <see cref="ImageFormat" /> object.</returns>
        public Guid Guid
        {
            get
            {
        ...
        /// is an <see cref="ImageFormat" /> object
        /// that is equivalent to this
        /// <see cref="ImageFormat" />
        /// object.</summary>
        /// <returns>true if <paramref name="o" /> is an
        /// <see cref="ImageFormat" /> object that is
        /// equivalent to this <see cref="ImageFormat" />
        ...
        /// <summary>Converts this <see cref="ImageFormat" />
