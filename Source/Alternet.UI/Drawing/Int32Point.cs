...
namespace Alternet.Drawing
{
    ...
    */
    ...
    public struct Int32Point : IEquatable<Int32Point>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref='Drawing.Int32Point'/>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref='Drawing.Int32Point'/>
        /// class from a <see cref='Drawing.Size'/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref='Drawing.Int32Point'/>
        /// is empty.
        /// </summary>
        [Browsable(false)]
        ...
        /// the specified <see cref='Drawing.Int32Point'/> .
        /// </summary>
        public static explicit operator Int32Size(Int32Point p) => new(p.X, p.Y);

        /// <summary>
        /// Implicit operator convertion from tuple with two <see cref="int"/> values
        /// to <see cref="Int32Point"/>.
        /// </summary>
        /// <param name="d">New point value.</param>
        public static implicit operator Int32Point((int, int) d) => new(d.Item1, d.Item2);

        /// <summary>
        /// Translates a <see cref='Drawing.Int32Point'/> by a given
        ...
        /// <summary>
        /// Translates a <see cref='Drawing.Int32Point'/> by the negative of
        /// a given <see cref='Drawing.Int32Size'/> .
        /// </summary>
        public static Int32Point operator -(Int32Point pt, Int32Size sz) =>
            Subtract(pt, sz);

        /// <summary>
        /// Compares two <see cref='Drawing.Int32Point'/> objects. The result
        /// specifies whether the values of the
        /// <see cref='Drawing.Int32Point.X'/> and
        /// <see cref='Drawing.Int32Point.Y'/> properties of the two
        ...
        /// <summary>
        /// Compares two <see cref='Drawing.Int32Point'/> objects.
        /// The result specifies whether the values of the
        /// <see cref='Drawing.Int32Point.X'/> or
        /// <see cref='Drawing.Int32Point.Y'/> properties of the two
        ...
        /// <see cref='Drawing.Int32Size'/> .
        /// </summary>
        public static Int32Point Add(Int32Point pt, Int32Size sz) =>
            new(unchecked(pt.X + sz.Width), unchecked(pt.Y + sz.Height));

        /// <summary>
        /// Translates a <see cref='Drawing.Int32Point'/> by the negative
        /// of a given <see cref='Drawing.Int32Size'/> .
        /// </summary>
        ...
        /// <summary>
        /// Specifies whether this <see cref='Drawing.Int32Point'/> contains
        /// the same coordinates as the specified
        /// <see cref='object'/>.
        /// </summary>
        public override readonly bool Equals([NotNullWhen(true)] object? obj) =>
            obj is Int32Point point && Equals(point);
