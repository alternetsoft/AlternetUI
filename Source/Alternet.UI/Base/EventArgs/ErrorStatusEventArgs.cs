...
{
    /// <summary>
    /// Represents the method that will handle <see cref="TextBox.ErrorStatusChanged"/>
    /// and similar events.
    /// </summary>
    ...
    /// <summary>
    /// Provides data for the <see cref="TextBox.ErrorStatusChanged"/> and similar events.
    /// </summary>
