...
{
    public class TransportConnectionWrapper : IAlternetUIRemoteTransportConnection
    {
        private readonly IAlternetUIRemoteTransportConnection _conn;
        ...
        public TransportConnectionWrapper(IAlternetUIRemoteTransportConnection conn)
        {
            _conn = conn;
