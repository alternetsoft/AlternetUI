...
=======================
    ...
    long GetDelayedImageProcessingTime() { return m_delayedImageProcessingTime; }

    // 
        Sets the last time delayed image processing was performed.
    
    void SetDelayedImageProcessingTime(long t) { m_delayedImageProcessingTime = t; }
...
// Returns the range of the current selection.
   //     The end point of range is specified as the last character position of the span
    ...
    wxRichTextRange GetSelectionRange()
    ...
    void SetInternalSelectionRange(wxRichTextRange& range) 
    ...
    wxRichTextRange AddImage(wxImage& image);
        ...
        bool HasParagraphAttributes(wxRichTextRange& range, wxRichTextAttr& style) => default;
    ...
    bool HasCharacterAttributes(wxRichTextRange& range, wxRichTextAttr& style)
