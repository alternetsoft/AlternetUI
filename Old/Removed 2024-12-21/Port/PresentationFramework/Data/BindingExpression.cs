            ...
            */
            ...
            if (ParentBinding.SourceReference == null)
            {
                ...
                if (TargetProperty == FrameworkElement.DataContextProperty ||
                    /* yezo (TargetProperty == ContentPresenter.ContentProperty &&
...
#region Activation
        ...
        internal override void Activate()
        {
            ...
            else
            {
                ...
                if (StatusInternal == BindingStatusInternal.Inactive || !ItemsControl.EqualsEx(item, DataItem))
                {
                    Activate(item);
                }
            }
...
#region Value
        ...
        private bool ShouldIgnoreUpdate()
        {
            ...
            */
            ...
            if (!ItemsControl.EqualsEx(DataItem, item))
                return true;
...
#region Event handlers
        ...
        private void OnDataContextChanged(DependencyObject contextElement)
        {
            ...
            if (!IsInUpdate && CanActivate)
            {
                ...
                if (!ItemsControl.EqualsEx(DataItem, newItem))
                {
                    Activate(newItem);
                }
            }
