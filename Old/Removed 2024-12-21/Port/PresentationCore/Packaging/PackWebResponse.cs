        ...
        public override Stream GetResponseStream()
        {
            ...
            if (_responseStream == null)
            {
                ...
                else
                {
                    ...
                    _mimeType = new ContentType(p.ContentType);      // save this for use in ContentType property - may still be null
...
#endif
                            _parent._mimeType = new ContentType(p.ContentType);
...
//                    _webRequest = null;     // don't need this anymore so release
        ...
        //
        //------------------------------------------------------
        private ContentType     _mimeType;              // type of the returned stream - cached because it never changes
