...
namespace Alternet.UI.Port
{
    ...
    internal static class TreeWalkHelper
    {
            ...
            bool isAddOperation)
        {
            ...
            DependencyObject d = (fe != null) ? (DependencyObject)fe : /*(DependencyObject)fce*/null;
            ...
            bool wasSelfInheritanceParent)
        {
            ...
            DependencyObject d = fe != null ? (DependencyObject)fe : null;
        ...
        private static bool IsForceInheritedProperty(DependencyProperty dp)
        {
            ...
            return false;// (dp == FrameworkElement.FlowDirectionProperty);
        }
