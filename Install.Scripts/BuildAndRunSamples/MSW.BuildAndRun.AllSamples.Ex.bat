...
call "%SCRIPT_HOME%\MSW.BuildAndRunSample.bat" %SAMPLE_FOLDER% PreviewSample %2 %3
call "%SCRIPT_HOME%\MSW.BuildAndRunSample.bat" %SAMPLE_FOLDER% PropertyGridSample %2 %3