...
## Input API
 The primary input API exposure is found on the base control classes:
 <xref:Alternet.UI.AbstractControl>, <xref:Alternet.UI.Control>. These
...
## The Input System and Base Elements
 Input events are raised by the input system and
 ...
 on <xref:Alternet.UI.AbstractControl>,
